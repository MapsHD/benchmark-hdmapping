...
# Script to run GLIM benchmarks for ALL datasets
...
#
# Usage: ./run_all_glim.sh BASE_PATH
...
echo "======================================"
echo "Running GLIM benchmarks for all datasets"
echo "======================================"
...
for SENSOR_DIR in $SENSOR_DIRS; do
    ...
    elif [ -f "./methods/benchmark-GLIM-to-HDMapping/configs/${CONFIG}.env" ]; then
...
for SENSOR_DIR in $SENSOR_DIRS; do
    ...
    CONFIG_FILE="./methods/benchmark-GLIM-to-HDMapping/configs/${CONFIG}.env"
    ...
    echo "Running GLIM benchmark for $EXPERIMENT_NAME with config: $CONFIG..."
    START_TIME=$(date +%s)
    
    if ./methods/benchmark-GLIM-to-HDMapping/run_benchmark.sh "$CONFIG" "$INPUT_BAG_DIRECTORY"; then
        END_TIME=$(date +%s)
...
echo "======================================"
echo "All GLIM benchmarks completed!"
