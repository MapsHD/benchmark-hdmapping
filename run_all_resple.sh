...
# Script to run RESPLE benchmarks for ALL datasets
...
#
# Usage: ./run_all_resple.sh BASE_PATH
...
echo "======================================"
echo "Running RESPLE benchmarks for all datasets"
echo "======================================"
...
for SENSOR_DIR in $SENSOR_DIRS; do
    ...
    elif [ -f "./methods/benchmark-RESPLE-to-HDMapping/configs/${CONFIG}.env" ]; then
...
for SENSOR_DIR in $SENSOR_DIRS; do
    ...
    CONFIG_FILE="./methods/benchmark-RESPLE-to-HDMapping/configs/${CONFIG}.env"
    ...
    echo "Running RESPLE benchmark for $EXPERIMENT_NAME with config: $CONFIG..."
    START_TIME=$(date +%s)
    
    if ./methods/benchmark-RESPLE-to-HDMapping/run_benchmark.sh "$CONFIG" "$INPUT_BAG_DIRECTORY"; then
        END_TIME=$(date +%s)
...
echo "======================================"
echo "All RESPLE benchmarks completed!"
