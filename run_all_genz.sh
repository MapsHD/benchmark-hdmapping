...
# Script to run GenZ-ICP benchmarks for ALL datasets
...
#
# Usage: ./run_all_genz.sh BASE_PATH
...
echo "======================================"
echo "Running GenZ-ICP benchmarks for all datasets"
echo "======================================"
...
while IFS= read -r SENSOR_DIR; do
    ...
    elif [ -f "./methods/benchmark-GenZ-ICP-to-HDMapping/configs/${CONFIG}.env" ]; then
...
while IFS= read -r SENSOR_DIR; do
    ...
    CONFIG_FILE="./methods/benchmark-GenZ-ICP-to-HDMapping/configs/${CONFIG}.env"
    ...
    echo "Running GenZ-ICP benchmark for $EXPERIMENT_NAME with config: $CONFIG..."
    START_TIME=$(date +%s)
    
    if ./methods/benchmark-GenZ-ICP-to-HDMapping/run_benchmark.sh "$CONFIG" "$INPUT_BAG_DIRECTORY"; then
        END_TIME=$(date +%s)
...
echo "======================================"
echo "All GenZ-ICP benchmarks completed!"
